...
namespace SimCorp.IMS.CSharpPrepCourse
{
    ...
    {
        public USB3_0(_SupportInductiveCharge inductiveCharge, _ChargingTechnology chargingTechnology) : base(inductiveCharge, chargingTechnology)
        {
        ...
        {
            Console.WriteLine($"battery now is charging using {nameof(USB3_0)}");
